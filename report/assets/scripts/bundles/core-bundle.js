!(function (a, b) {
      ...
      "margin" === c && (f += $.css(a, c + qc[e], !0)),
        d
          ? ("content" === c &&
            ...
            "margin" !== c &&
              (f -= parseFloat(cc(a, "border" + qc[e] + "Width")) || 0))
          : ((f += parseFloat(cc(a, "padding" + qc[e])) || 0),
            "padding" !== c &&
              (f += parseFloat(cc(a, "border" + qc[e] + "Width")) || 0));
    return f;
  ...
  function v(a, b, c) {
    ...
    if (0 >= d || null == d) {
      if (
        ((d = cc(a, b)), (0 > d || null == d) && (d = a.style[b]), lc.test(d))
      )
        return d;
    ...
    mb = function () {
      P.addEventListener
        ...
        : "complete" === P.readyState &&
          (P.detachEvent("onreadystatechange", mb), $.ready());
    },
    nb = {};
  ($.fn = $.prototype =
    {
  ...
  var Bb = /^(?:textarea|input|select)$/i,
    ...
    Hb = function (a) {
      return $.event.special.hover
        ? a
        : a.replace(Db, "mouseenter$1 mouseleave$1");
    };
  ($.event = {
    ...
    $.support.submitBubbles ||
      ($.event.special.submit = {
        ...
        teardown: function () {
          return $.nodeName(this, "form")
            ? !1
            : ($.event.remove(this, "._submit"), void 0);
        },
      }),
        ...
        if (!d && 1 === l.length) {
          ...
          for (
            ...
            if (
              (k = t.find[j]) &&
              (d = k(
                i.matches[0].replace(gb, ""),
                (db.test(g[0].type) && b.parentNode) || b,
                e,
              ))
            ) {
    ...
    $.extend({
      ...
      ajax: function (a, c) {
        ...
        if (
          ...
          !m.hasContent &&
            (m.data &&
              ((m.url += (Fc.test(m.url) ? "&" : "?") + m.data), delete m.data),
            (e = m.url),
            m.cache === !1))
        ) {
          var x = $.now(),
                  ...
                  try {
                    if (d && (e || 4 === i.readyState))
                      if (
                        ((d = b),
                        g &&
                          ((i.onreadystatechange = $.noop), Tc && delete Sc[g]),
                        e)
                      )
  ...
  ($.Animation = $.extend(H, {
    ...
    ($.fx.timer = function (a) {
      a() &&
        $.timers.push(a) &&
        !Wc &&
        (Wc = setInterval($.fx.tick, $.fx.interval));
    }),
    ($.fx.interval = 13),
    ($.fx.stop = function () {
  ...
  (function (a, b) {
    ...
    function i() {
      ...
      if (
        ...
        b.b
          ...
          : b.h &&
            (d +=
              "var m=l.length;i=-1;if(m&&j(l)){while(++i<m){i+='';" +
              b.g +
              "}}else {"),
        b.e || (d += "var u=typeof l=='function'&&s.call(l,'prototype');"),
        b.f && b.l
          ? ((d +=
              "var q=-1,r=p[typeof l]?n(l):[],m=r.length;while(++q<m){i=r[q];"),
      ...
      return (
        (b.b || b.h) && (d += "}"),
        (d += b.c + ";return t"),
        c("e,h,j,k,p,n,s", "return function(" + a + "){" + d + "}")(
          h,
          xb,
          p,
          z,
    ...
    function n(a, b, c) {
      ...
      for (var d = -1, c = c - b || 0, e = Array(0 > c ? 0 : c); ++d < c; )
        e[d] = a[b + d];
      return e;
    }
    function o(a) {
    ...
    function s(a, b, c, d, e) {
      ...
      return (
        ...
        g &&
          (xb.call(a, "index") && (h.index = a.index),
          xb.call(a, "input") && (h.input = a.input)),
        h
      );
    }
    function t(a) {
    ...
    function A(a, b, c) {
      ...
      for (
        c !== cb &&
        ((g = []), (h = []), "number" != typeof c && (f = d.length));
        ++e < f;
    ...
    function D(a, b, c) {
      var d = !0,
        b = h(b, c);
      if (oc(a))
        for (var c = -1, e = a.length; ++c < e && (d = !!b(a[c], c, a)); );
      else
        hc(a, function (a, c, e) {
          return (d = !!b(a, c, e));
        });
    ...
    function R(a, b, c, d) {
      for (
        var e = 0, f = a ? a.length : e, c = c ? h(c, d) : U, b = c(b);
        f > e;
    ...
    function S(a, b, c, d) {
      ...
      for (c && ((i = []), (c = h(c, d))); ++e < f; ) {
        ...
        (b ? !e || i[i.length - 1] !== l : m || 0 > P(i, l)) &&
          ((c || j) && i.push(l), g.push(d));
      }
      return g;
    }
    function T(a, b) {
    ...
    var pc = wb
      ...
      qc = Fb
        ? function (a) {
            return "function" == typeof a && zb.call(a, "prototype")
              ? r(a)
              : x(a)
                ? Fb(a)
                : [];
    ...
    (c.after = function (a, b) {
      ...
      (c.intersection = function (a) {
        ...
        a: for (; ++f < g; ) {
          ...
          if (l || 0 > P(j, k)) {
            h && j.push(k);
            for (var m = c; --m; )
              if (!(e[m] || (e[m] = d(b[m], 0, 100)))(k)) continue a;
            i.push(k);
          }
        }
        return i;
      ...
      (c.times = function (a, b, c) {
        for (var a = +a || 0, d = -1, e = Array(a); ++d < a; )
          e[d] = b.call(c, d);
        return e;
      }),
      (c.toArray = function (a) {
        return "number" == typeof (a ? a.length : 0)
          ? Zb && z(a)
            ? a.split("")
            : n(a)
          : B(a);
      ...
      (c.without = function (a) {
        for (
          var b = -1, c = a ? a.length : 0, e = d(arguments, 1, 20), f = [];
          ++b < c;
      ...
      (c.zip = function (a) {
        for (
          var b = -1, c = a ? I(J(arguments, "length")) : 0, d = Array(c);
          ++b < c;
  ...
  (function () {
      ...
      if (e)
        for (v = 0, w = fc.length; w > v; v++) {
          ...
          if (t.el.id == b.id && t.anim == a) {
            t.percent != c ? (fc.splice(v, 1), (k = 1)) : (j = t),
              b.attr(t.totalOrigin);
            break;
          }
        }
      else e = +q;
        ...
        if (j) (j.initstatus = e), (j.start = new Date() - j.ms * e);
                ...
                case "transform":
                  ...
                  if (I)
                    for (
                      ...
                      for (
                        s[y][v] = [p[y][v][0]], D = 1, E = p[y][v].length;
                        E > D;
                        D++
                      )
          ...
          if (
            ...
            e &&
              !j &&
              !k &&
              ((t.stop = !0), (t.start = new Date() - o * e), 1 == fc.length))
          )
            return hc();
    ...
    function g(a, b, c) {
      ...
      for (
        var d, e, f, g, i, j, k, l, m, n, o = c ? 0 : [], p = 0, q = a.length;
        q > p;
        p++
      ) {
        var s = a[p];
    ...
    function h(a, b, c) {
      ...
      for (p = 0; j + 1 > p; p++)
        (q = r.findDotsAtSegment.apply(r, b.concat(p / j))),
          m.push({ x: q.x, y: q.y, t: p / j });
      for (p = 0; h > p; p++)
        for (var s = 0; j > s; s++) {
          var t = l[p],
            u = l[p + 1],
    ...
    if (
      ...
      (r.type =
        y.win.SVGAngle ||
        y.doc.implementation.hasFeature(
    ...
    (r.getRGB = o(function (a) {
      ...
      !db[x](a.toLowerCase().substring(0, 2)) &&
        "#" != a.charAt() &&
        (a = sb(a));
      var b,
        c,
          ...
          h[5]
            ...
            : h[6]
              ...
              : ((h = { r: b, g: c, b: d, toString: n }),
                (h.hex =
                  "#" +
                  (16777216 | d | (c << 8) | (b << 16)).toString(16).slice(1)),
          ...
          d.length ||
            G(a).replace(fb, function (a, b, e) {
              ...
              if (
                ...
                for (
                  ;
                  f.length >= c[g] && (d.push([b][C](f.splice(0, c[g]))), c[g]);
    ...
    var zb = (r.pathBBox = function (a) {
        ...
        a = Ib(a);
        for (
          var c, d = 0, e = 0, f = [], g = [], h = 0, i = a.length;
          i > h;
          h++
        )
          if (((c = a[h]), "M" == c[0]))
            ...
            (f = f[C](j.min.x, j.max.x)),
              (g = g[C](j.min.y, j.max.y)),
              (d = c[5]),
              (e = c[6]);
          }
        var k = N[B](0, f),
        ...
        for (
          ...
          if ((c.push((i = [])), (j = a[l]), j[0] != _.call(j[0])))
            switch (((i[0] = _.call(j[0])), i[0])) {
              ...
              case "R":
                for (
                  var o = [d, e][C](j.slice(1)), p = 2, q = o.length;
                  q > p;
                  p++
                )
                  (o[p] = +o[p] + d), (o[++p] = +o[p] + e);
      ...
      Gb = function (a, b, c, d, e, f, g, h, i) {
        ...
        return {
          x:
            P(j, 3) * a + 3 * P(j, 2) * i * c + 3 * j * i * i * e + P(i, 3) * g,
          y:
            P(j, 3) * b + 3 * P(j, 2) * i * d + 3 * j * i * i * f + P(i, 3) * h,
        };
      },
      Hb = o(function (a, b, c, d, e, f, g, h) {
        ...
        return (
          ...
          m > 0 &&
            1 > m &&
            ((i = Gb(a, b, c, d, e, f, g, h, m)), p.push(i.x), o.push(i.y)),
          n > 0 &&
            1 > n &&
            ((i = Gb(a, b, c, d, e, f, g, h, n)), p.push(i.x), o.push(i.y)),
          (j = f - 2 * d + b - (h - 2 * f + d)),
          (k = 2 * (d - b) - 2 * (f - d)),
          (l = b - d),
          (m = (-k + L.sqrt(k * k - 4 * j * l)) / 2 / j),
      ...
      Jb =
        ((r._parseDots = o(function (a) {
          ...
          for (c = 1, d = b.length - 1; d > c; c++)
            if (!b[c].offset) {
              for (
                var g = Z(b[c - 1].offset || 0), h = 0, i = c + 1;
                d > i;
                i++
              )
                if (b[i].offset) {
      ...
      Nb = (r._equaliseTransform = function (a, b) {
        ...
        for (
          var c, d, e, f, g = M(a.length, b.length), h = [], i = [], j = 0;
          g > j;
          j++
        ) {
          if (
            ...
            return;
          for (
            h[j] = [], i[j] = [], c = 0, d = M(e.length, f.length);
            d > c;
            c++
          )
          ...
          return y.doc.addEventListener
            ? function (a, b, c, d) {
                var e = D && J[b] ? J[b] : b,
                  f = function (e) {
                    var f =
                        y.doc.documentElement.scrollTop || y.doc.body.scrollTop,
                      g =
                        y.doc.documentElement.scrollLeft ||
                        y.doc.body.scrollLeft,
                      h = e.clientX + g,
                      i = e.clientY + f;
                    if (D && J[x](b))
                      for (
                        var j = 0,
                          k = e.targetTouches && e.targetTouches.length;
                        k > j;
                        j++
                      )
    ...
    (Xb.data = function (a, b) {
      ...
      (Xb.removeData = function (a) {
        return (
          null == a ? (ib[this.id] = {}) : ib[this.id] && delete ib[this.id][a],
          this
        );
      }),
    ...
    var _b = function (a, b, c, d, e, f, g, h, i) {
      ...
      ac = function (a, b) {
        return function (c, d, e) {
          c = Ib(c);
          for (
            var f, g, h, i, j, k = "", l = {}, m = 0, n = 0, o = c.length;
            o > n;
            n++
          ) {
            if (((h = c[n]), "M" == h[0])) (f = +h[1]), (g = +h[2]);
              ...
              if (
                ((i = _b(f, g, h[1], h[2], h[3], h[4], h[5], h[6])), m + i > d)
              ) {
                if (b && !l.start) {
                  if (
    ...
    (r.getTotalLength = bc),
      ...
      (Xb.getSubpath = function (a, b) {
        return "path" == this.type
          ? r.getSubpath(this.attrs.path, a, b)
          : void 0;
      });
    var ec = (r.easing_formulas = {
      ...
      elastic: function (a) {
        return a == !!a
          ? a
          : P(2, -10 * a) * L.sin((2 * (a - 0.075) * Q) / 0.3) + 1;
      },
      bounce: function (a) {
        var b,
          c = 7.5625,
        ...
        for (var a = +new Date(), c = 0; c < fc.length; c++) {
          ...
          if (!d.el.removed && !d.paused) {
            ...
            if (
              (d.initstatus
                ? ((g =
                    ((d.initstatus * d.anim.top - d.prev) /
                      (d.percent - d.prev)) *
                    h),
                ...
                : (d.status =
                    (d.prev + (d.percent - d.prev) * (g / h)) / d.anim.top),
              !(0 > g))
            )
              if (h > g) {
                var p = i(g / h);
                  ...
                  if (j[x](q)) {
                    switch (bb[q]) {
                      ...
                      case "transform":
                        if (k[q].real)
                          for (e = [], s = 0, t = j[q].length; t > s; s++)
                            for (
                              e[s] = [j[q][s][0]], u = 1, v = j[q][s].length;
                              v > u;
                              u++
                            )
                              e[s][u] = j[q][s][u] + p * h * k[q][s][u];
                      ...
                      default:
                        var y = [][C](j[q]);
                        for (
                          e = [], s = m.paper.customAttributes[q].length;
                          s--;
                ...
                d.next &&
                  !d.stop &&
                  b(d.anim, d.el, d.next, null, d.totalOrigin, d.repeat);
              }
          }
        }
    ...
    (Xb.animateWith = function (a, d, e, f, g, h) {
      ...
      (r.animation = function (a, b, d, e) {
        ...
        return f
          ? (d && (h.easing = d), e && (h.callback = e), new c({ 100: h }, b))
          : new c(a, b);
      }),
    ...
    (kc.attr = function (a, b) {
      if (a && r.is(a, T) && r.is(a[0], "object"))
        ...
        for (var e = 0, f = this.items.length; f > e; e++)
      ...
      (kc.animate = function (a, b, c, d) {
        ...
        for (e = this.items[--h].animate(j); h--; )
          this.items[h] &&
            !this.items[h].removed &&
            this.items[h].animateWith(e, j, j);
        return this;
      }),
          ...
          for (
            ...
            if ("\n" == i[s]) (j = 0), (w = 0), (k = 0), (p += o);
              ...
              var v = (k && d.glyphs[i[s - 1]]) || {},
                w = d.glyphs[i[s]];
              (j += k ? (v.w || d.w) + ((v.k && v.k[i[s]]) || 0) + d.w * g : 0),
                (k = 1);
            }
            w &&
              w.d &&
            ...
            if (
              ...
              f
                ...
                : ((g = 0),
                  (h = a.getTotalLength(t.path) - (d._.arrows.enddx * u || 0))),
                d._.arrows[r + "Path"] &&
                  q(s, { d: Raphael.getSubpath(t.path, g, h) }),
      ...
      (b.Line = (function (a) {
        ...
        return (
          ...
          (c.prototype.onGridClick = function (a, b) {
            ...
            return (
              (c = this.hitTest(a, b)),
              this.fire("click", c, this.options.data[c], a, b)
            );
          }),
            ...
            return (this.paths = function () {
              ...
              for (
                ...
                (f =
                  ...
                  ((j = this.options.ykeys[d]),
                  i.call(this.options.smooth, j) >= 0)),
                  (c = function () {
                    var a, b, c, f;
                    for (c = this.data, f = [], a = 0, b = c.length; b > a; a++)
                      (e = c[a]),
                        void 0 !== e._y[d] && f.push({ x: e._x, y: e._y[d] });
                    return f;
                  }.call(this)),
                  ...
                  c.length > 1
                    ? k.push(b.Line.createPath(c, f, this.bottom))
                    : k.push(null);
              return k;
            }.call(this));
          }),
          ...
          (c.prototype._drawLineFor = function (a) {
            ...
            return (
              (b = this.paths[a]),
              null !== b
                ? this.drawLinePath(b, this.colorFor(null, a, "line"))
                : void 0
            );
          }),
            ...
            if (null !== a && this.prevHilight !== a)
              for (
                ...
                this.seriesPoints[b][a] &&
                  this.seriesPoints[b][a].animate(this.pointGrow);
          ...
          (c.prototype.strokeWidthForSeries = function (a) {
            return this.options.pointWidths[
              a % this.options.pointWidths.length
            ];
          }),
        ...
        return (
          ...
          (d.prototype.calcBars = function () {
            ...
            for (f = this.data, g = [], a = d = 0, e = f.length; e > d; a = ++d)
              (b = f[a]),
                (b._x =
                  this.left + (this.width * (a + 0.5)) / this.data.length),
                g.push(
                  (b._y = function () {
                    var a, d, e, f;
          ...
          (d.prototype.drawSeries = function () {
            ...
            return (
              ...
              (h =
                null != this.options.stacked ? 1 : this.options.ykeys.length),
              (a =
              ...
              (this.bars = function () {
                var h, o, p, q;
                for (
                  p = this.data, q = [], d = h = 0, o = p.length;
                  o > h;
                  d = ++h
                )
                  (i = p[d]),
              ...
              this.text1 = this.drawEmptyDonutLabel(
                ...
                h = Math.max.apply(
                  ...
                  function () {
                    var a, b, c, d;
                    for (
                      c = this.values, d = [], a = 0, b = c.length;
                      b > a;
                      a++
                    )
                      (m = c[a]), d.push(m);
