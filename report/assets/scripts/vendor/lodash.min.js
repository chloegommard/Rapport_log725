...
(function () {
  ...
  function s(e) {
    ...
    function _(n, t, e) {
      ...
      for (
        ...
        if ((u = i[a]) && V[typeof u])
          for (
            var l = -1, c = V[typeof u] && Fe(u), p = c ? c.length : 0;
            ++l < p;
    ...
    function U(n, t, e) {
      ...
      for (; ++a < f; )
        if ((u = i[a]) && V[typeof u])
          for (
            var c = -1, p = V[typeof u] && Fe(u), s = p ? p.length : 0;
            ++c < s;
    ...
    function J(n) {
      return n && typeof n == "object" && !Te(n) && me.call(n, "__wrapped__")
        ? n
        : new Q(n);
    }
    function Q(n, t) {
    ...
    function Z(n, t, e, r, u) {
      ...
      return (
        i &&
          (me.call(n, "index") && (o.index = n.index),
          me.call(n, "input") && (o.input = n.input)),
        t
          ? (r.push(n),
            u.push(o),
    ...
    function et(n) {
      function t() {
        ...
        return (o || c) &&
          (h || (h = p(arguments)), o && be.apply(h, o), c && h.length < a)
    ...
    function ot(n, t, e, r, u, o) {
      ...
      if ((u.push(n), o.push(t), c)) {
        ...
        g(t, function (t, a, f) {
          return me.call(f, a)
            ? (v++, (i = me.call(n, a) && ot(n[a], t, e, r, u, o)))
            : void 0;
        }),
          i &&
            !r &&
    ...
    function ft(e, r, u) {
      ...
      for (v && ((h = o(h)), (f = t)); ++i < p; ) {
        var g = e[i],
          y = u ? u(g, i, e) : g;
        (r ? !i || h[h.length - 1] !== y : 0 > f(h, y)) &&
          ((u || v) && h.push(y), s.push(g));
      }
    ...
    function ht(n) {
      ...
      return n &&
        ce.call(n) == q &&
        ((t = n.constructor), !dt(t) || t instanceof t)
        ? (g(n, function (n, t) {
            e = t;
          }),
    ...
    function Vt(n, t, e) {
      function r() {
        c && ve(c),
          (i = c = p = v),
          (g || h !== t) &&
            ((s = Ue()), (a = n.apply(l, o)), c || i || (o = l = null));
      }
      function u() {
        var e = t - (Ue() - f);
        0 < e
    ...
    return (
      ...
      (J.intersection = function () {
        for (
          ...
          var v = arguments[r];
          (Te(v) || yt(v)) &&
            (e.push(v), i.push(p && v.length >= b && o(r ? e[r] : s)));
        }
        var p = e[0],
          h = -1,
          g = p ? p.length : 0,
      ...
      (J.omit = function (n, t, e) {
        ...
        if (typeof t != "function") {
          ...
          for (
            var u = rt(u, ut(arguments, true, false, 1)), o = -1, i = u.length;
            ++o < i;
      ...
      (J.isEmpty = function (n) {
        ...
        return e == $ ||
          e == P ||
          e == D ||
          (e == q && typeof r == "number" && dt(n.splice))
          ? !r
          : (h(n, function () {
              return (t = false);
            }),
  ...
  var v,
    ...
    K = {};
  (K[B] = false),
    (K[D] = K[$] = K[T] = K[F] = K[W] = K[q] = K[z] = K[P] = true);
